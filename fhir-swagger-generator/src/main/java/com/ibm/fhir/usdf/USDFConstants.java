...
public class USDFConstants {
    public static final String BASE_PATH = "/home/isurus/prime_fhir/FHIR";
//    public static final String EXTENSIONS_PATH = "src/main/resources/extensions";
    public static final String EXTENSIONS_PATH = BASE_PATH + "/fhir-swagger-generator/target/classes/extensions";
